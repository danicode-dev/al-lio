...
export function NewsView() {
  ...
  return (
    ...
    // `al-news-view` scope adds one phone-only tweak on top of that shared
    // rhythm (globals.css): the search / reload / filters cluster is lifted
    // into the free top-right band of this header instead of taking its own
    // row, so the stat grid and the featured card start higher.
    <div className="space-y-6 al-news-view">
      <PageHeader
