    ...
    <footer className="relative z-10 border-t border-[#E8E1D2]">
      <div className="mx-auto flex max-w-[1120px] flex-col gap-10 px-6 py-12 text-[14px] sm:px-12 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex gap-12">
          <div>
            <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.12em] text-[#9a958a]">Producto</p>
            <ul className="space-y-2.5 text-[#55514a]">
          ...
          <div>
            <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.12em] text-[#9a958a]">Legal</p>
            <ul className="space-y-2.5 text-[#55514a]">
