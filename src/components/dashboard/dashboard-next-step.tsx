...
export function DashboardNextStep({ roadmap }: { roadmap: RoadmapOverview | null }) {
  if (!roadmap) {
    return (
      <section className="rounded-[22px] border border-[#e4dfd5] bg-[#114b3b] p-5 text-white shadow-[0_18px_40px_rgba(19,75,59,0.18)]">
        ...
        <h2 className="mt-7 text-xl font-extrabold tracking-[-0.025em]">Prepara tu ruta</h2>
        <p className="mt-2 max-w-sm text-sm leading-6 text-white/75">Completa tu perfil formativo para recibir un siguiente paso adaptado a ti.</p>
        <Link href="/profile" className="mt-6 inline-flex h-10 items-center gap-2 rounded-xl bg-[#f06a37] px-4 text-sm font-bold text-white transition hover:bg-[#e15d2d]">
