import type { FpCatalogItem, Hackathon, ReturnTypeActions } from "@/components/store/types";
import type { TechOpportunity } from "@/lib/tech-opportunities/tech-opportunity-types";

// Duplicated from src/lib/fp/event-lifecycle.ts rather than imported: this
...
export function toggleHackathonFavoriteFor(item: Hackathon, actions: ReturnTypeActions) {
